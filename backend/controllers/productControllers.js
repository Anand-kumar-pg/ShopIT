...
//single product details => products/:id
...
// Delete/Update product review => /api/v1/admin/reviews
export const deleteReview = catchAsyncErrors(async (req, res, next) => {
    ...
    try {
        ...
        const reviewIndex = product.reviews.findIndex(review => review._id.toString() === id.toString());
        ...
        product.numOfReviews = product.reviews.length;
        product.ratings = product.reviews.length > 0 ? product.reviews.reduce((acc, review) => acc + review.rating, 0) / product.reviews.length : 0;
